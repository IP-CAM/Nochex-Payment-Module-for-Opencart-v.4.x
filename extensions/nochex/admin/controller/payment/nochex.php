...
namespace Opencart\Admin\Controller\Extension\Nochex\Payment;
...
class Nochex extends \Opencart\System\Engine\Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			'text' => "Nochex",
			'href' => $this->url->link('extension/nochex/payment/nochex', 'user_token=' . $this->session->data['user_token'], true)
		);

		$data['action'] = $this->url->link('extension/nochex/payment/nochex', 'user_token=' . $this->session->data['user_token'], true);
		...
		$this->response->setOutput($this->load->view('extension/nochex/payment/nochex', $data)); 
	}

	protected function validate() {
	
		if (!$this->user->hasPermission('modify', 'extension/nochex/payment/nochex')) {
